...
function openPowerpoint() {
    hideAllModules();
    loadPresentations();  // Load the list of presentations
...
function loadPresentations() {
    fetch('/api/powerpoint/list_presentations/', {
        method: 'GET'
    })
    ...
    .then(data => {
        if (data.presentations) {
            ...
            data.presentations.forEach(presentation => {
                ...
                item.ondblclick = () => startPresentation();
...
function openPresentation(fileName) {
    fetch(`/api/powerpoint/open_presentation/${encodeURIComponent(fileName)}/`, {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
